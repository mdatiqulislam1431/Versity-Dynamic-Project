 ...
 <?php include 'file/sitebar.php'; ?>
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-dashboard"></i> Update Notification </h1>
          <p>Update Notification of website</p>
        </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item"><a href="#">Update Notification</a></li>
        </ul>
      </div>
...
<?php 
     ...
     if($_SERVER['REQUEST_METHOD'] == 'POST'){
       ...
       $content = mysqli_real_escape_string($db->link, $_POST['content']);
            ...
            if ($file_size >1048567) {
                ...
                if ($updated_rows) {
                    $m="Notification Upload successfully. Thanks for beign with us!";
                }else {
 ...
 ?>
        ...
        <div class="col-md-12">
          <div class="tile">
            <h3 class="tile-title">Edit Notification</h3>
            <div class="tile-body">
...
?>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="content" value="<?php echo $result['content']; ?>">
                </div>
                <div class="form-group">
