...
<?php include 'file/sitebar.php'; ?>
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-dashboard"></i> Add Toggle</h1>
          <p>New Add Toggle in Website</p>
        </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item"><a href="#">Add Toggle</a></li>
        </ul>
      </div>
       ...
       $content=mysqli_real_escape_string($db->link, $_POST['content']);
        ...
        if ($title == "") {
            ...
            $n="please fill content field";
              ...
              $query="INSERT INTO tbl_query_toggle(title, content) values('$title', '$content')";
              $news=$db->insert($query);

                   if ($news) {
                     $m="Toggle information Upload successfully. Thanks for beign with us!";
                   }else{
                     $n="Toggle not uploaded";
                   }
          }
    }
...
?>
      ...
      <div class="row">
       <div class="col-md-12">
          <div class="tile">
            <h3 class="tile-title">Add Toggle</h3>
            <div class="tile-body">
              ...
              <p class="text-center" style="color: red; letter-spacing: 2px;"><?php echo $n; ?></p>
                ...
                <div class="form-group">
                  ...
                  <textarea name="content" placeholder="Enter content here.." class="form-control" cols="30" rows="5"></textarea>
                </div>
