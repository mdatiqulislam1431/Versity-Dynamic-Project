...
<?php include 'file/sitebar.php'; ?>
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-dashboard"></i> Add Gallery</h1>
          <p>All new Woman Picture in website</p>
        </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item"><a href="#">Add Gallery woman</a></li>
        </ul>
      </div>
...
<?php 
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if ($file_size >1048567) {
              ...
              $query="INSERT INTO  tbl_gallery_woman(image) values('$uploaded_image')";
              $add_gallery_woman=$db->insert($query);

                   if ($add_gallery_woman) {
                     $m="Add Gallery Upload successfully. Thanks for beign with us!";
                   }else{
                     $n="Gallery not uploaded";
                   }
          }
    }
...
?>
      ...
      <div class="row">
       <div class="col-md-12">
          <div class="tile">
            <h3 class="tile-title">Add Gallery Woman</h3>
            <div class="tile-body">
