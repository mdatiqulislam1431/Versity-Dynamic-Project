...
<?php include 'file/sitebar.php'; ?>
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-dashboard"></i> Add Award</h1>
          <p>A New award of Website</p>
        </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item"><a href="#">Add award</a></li>
        </ul>
      </div>
       ...
       $title=mysqli_real_escape_string($db->link, $_POST['title']);
        ...
        if ($title == "") {
            $n="please fill title field";
              ...
              $query="INSERT INTO  tbl_award(title, image) values('$title', '$uploaded_image')";
              $slider=$db->insert($query);

                   if ($slider) {
                     $m="Award Upload successfully. Thanks for beign with us!";
                   }else{
                     $n="Award not uploaded";
                   }
          }
    }
...
?>
      ...
      <div class="row">
       <div class="col-md-12">
          <div class="tile">
            <h3 class="tile-title">Add Award</h3>
            <div class="tile-body">
