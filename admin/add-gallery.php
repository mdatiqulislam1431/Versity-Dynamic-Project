    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          ...
          <p>All new Beautiful Picture in website</p>
        </div>
...
<?php 
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if ($file_size >1048567) {
              ...
              $query="INSERT INTO  tbl_gallery_Beauty(image) values('$uploaded_image')";
              $add_gallery_beauty=$db->insert($query);

                   if ($add_gallery_beauty) {
...
?>
      ...
      <div class="row">
       <div class="col-md-12">
          <div class="tile">
            <h3 class="tile-title">Add Gallery</h3>
            <div class="tile-body">
